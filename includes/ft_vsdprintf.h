...
/*   Updated: 2019/12/18 13:14:02 by rbarbero         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned char	parse_width(t_conv *conv, const char **fmt, t_list **args
		, int *arg_i);
unsigned char	parse_precision(t_conv *conv, const char **fmt, t_list **args
		, int *arg_i);
...
unsigned char	take_str_args(t_list *args, va_list va_args);
